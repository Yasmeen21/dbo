...
//]]>
               ...
               function replaceKeyWordsInPopup ($page_id, $page_title, $popup_text){
                ...
                // set base attributes
                 ...
                 // image settings
                 $image_attributes = ' src="'.WP_PLUGIN_URL.'/share-and-follow/images/blank.gif" ';//DF: reversed the single and double quotes to avoid 404 errors
        ...
        public function follow_links($args = array()){
			...
			//DF: hardcoding eBay
			$html .= '<li class="iconOnly"><a rel="nofollow me" target="_blank" style="display:block;background: transparent url(http://www.diebutonce.com/wp-content/plugins/share-and-follow/default/24/ebay.png) no-repeat top left;height:24px;width:24px;" class="ebay" href="http://www.ebay.com/sch/diebutonce/m.html?item=200784532270&viewitem=&rt=nc&_trksid=p4340.l2562" title="Visit us on eBay"><span class="head">Visit us on eBay</span></a></li>';
