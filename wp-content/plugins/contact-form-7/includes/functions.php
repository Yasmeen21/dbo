...
function my_easymail_add_subscriber ( $cf7 ) {
        ...
        $fields['name'] = trim($cf7->posted_data["your-name"]);

		//DF: Subscribe to newsletter checkbox
        if ( function_exists ('alo_em_add_subscriber') && is_email($fields['email']) && isset($cf7->posted_data["sub-now"]) && $cf7->posted_data["sub-now"]!="" ) {
