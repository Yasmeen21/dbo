...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'dbo' ), max( $paged, $page ) );
...
<meta name="google-site-verification" content="qAU3DZZsTxyNSWQDB55rm3-W9kFJY-pgjKqxX3oJW_U" />
...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
			...
			<nav id="access" role="navigation">
				<h3 class="assistive-text"><?php _e( 'Main menu', 'dbo' ); ?></h3>
				<?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff. */ ?>
				<div class="skip-link"><a class="assistive-text" href="#content" title="<?php esc_attr_e( 'Skip to primary content', 'dbo' ); ?>"><?php _e( 'Skip to primary content', 'dbo' ); ?></a></div>
